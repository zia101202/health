...
const FAQS = [
  {
    ...
    a: "No. Conzultos Medical Family Advisory is not telehealth. It is a non-clinical advisory service provided by video call. The purpose is education, general guidance, healthcare navigation, and preparation for conversations with your treating medical team.",
  },
  ...
  { q: "Can multiple family members join the same video call?", a: null },
  { q: "What should I prepare before the call?", a: null },
  { q: "Will the physician advisor contact my treating doctor?", a: null },
  { q: "What if this is urgent or an emergency?", a: null },
];
  ...
  return (
    <section className="bg-white py-14 sm:py-20 lg:py-24 px-4 sm:px-6">
      <div className="max-w-[1012px] mx-auto flex flex-col gap-6 sm:gap-10">
        <h2 className="text-[#0a0a1a] text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-center">
          What other experts have asked us…
        </h2>
